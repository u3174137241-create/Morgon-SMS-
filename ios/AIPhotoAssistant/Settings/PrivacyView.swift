    ...
    var body: some View {
        List {
            Section {
                ...
                privacyRow(icon: "lock.shield", title: "Original ändras aldrig", text: "Genererade album refererar till dina befintliga bilder eller skapar separata exporter (PDF/bilder). Dina originalbilder tas aldrig bort, flyttas eller redigeras automatiskt.")
